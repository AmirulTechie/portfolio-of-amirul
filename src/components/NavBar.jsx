    ...
    <>
      ...
      >
        ...
        <a
          ...
          download
          className="hidden md:flex items-center gap-2 border border-white/25 hover:border-white/60 hover:bg-white/5 text-white text-[11px] uppercase tracking-widest px-4 py-2 transition-all duration-200 no-underline"
        >
